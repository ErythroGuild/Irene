...
class About {
	...
	private const string
		_pathVersion = @"secrets/git-tag.txt",
		_pathBuild   = @"secrets/git-commit.txt";
	...
	public static DiscordEmbed CollateStatusEmbed() {
		...
		string bodyText =
			...
			{statusAvailableCommands} **Usable commands:** {SlashCommandCount} [+{ContextCommandCount}], {helpLink}
